<template>
    <v-container>
            ...
            <v-card>
                ...
                <v-card-text>
                    <v-container>
                        <v-row>
                            <v-col cols="12">
                                <v-text-field label="Nama Layanan*" v-model="form.name" required></v-text-field>
                            </v-col>
                            <v-col cols="12">
                                <v-text-field label="Biaya Layanan*" v-model="form.price" required></v-text-field>
                            </v-col>
                            <v-col cols="12">
                                <v-select label="Jenis Layanan" v-model="form.type" :items="jenis"></v-select>
                            </v-col>
                            <!-- <v-col cols="12">
                                <v-text-field label="Tanggal dan Waktu*" v-model="form.created_at" required></v-text-field>
                            </v-col> -->
                        </v-row>
                    </v-container>
        ...
        <v-snackbar v-model="bar" :color="color" :multi-line="true" :timeout="3000"> {{ text }}
            <v-btn dark text @click="bar = false"> Close </v-btn>
        </v-snackbar>
    </v-container>
</template>
        ...
        methods: {
            ...
            sendData() {
                ...
                this.$http.post(uri, this.service).then(response => {
                    this.bar = true; //mengaktifkan snackbar 
                    this.color = 'green';
